from simple_romp.romp.model import ROMPv1
import cv2
import numpy as np
import os, sys
...
from simple_romp.romp.post_parser import SMPL_parser, body_mesh_projection2image, parsing_outputs
from simple_romp.romp.utils import img_preprocess, create_OneEuroFilter, euclidean_distance, check_filter_state, \
...
from simple_romp.vis_human import setup_renderer, rendering_romp_bev_results
from simple_romp.romp.post_parser import CenterMap
...
def romp_settings(input_args=sys.argv[1:]):
    ...
    parser.add_argument('--smpl_path', type=str, default='./smpl_packed_info.pth', help='The path of smpl model file')
    parser.add_argument('--model_path', type=str, default='./ROMP.pkl', help='The path of ROMP checkpoint')
    parser.add_argument('--model_onnx_path', type=str, default='./ROMP.onnx', help='The path of ROMP onnx checkpoint')
